...
export default function ReferralPage() {
    ...
    useWatchContractEvent({
        ...
        eventName: 'ReferralBonusPaid',
        onLogs(logs: readonly ReferralBonusPaidLog[]) {
            if (!address) return;
