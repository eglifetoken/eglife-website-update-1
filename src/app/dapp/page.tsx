        ...
        <main className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
             ...
             <div className="space-y-6">
                <Card className="bg-card/80 backdrop-blur-sm border-primary/20">
                    <CardHeader>
                        <CardTitle className="font-headline text-lg flex items-center gap-2"><Calendar className="h-5 w-5"/>Today's Income</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-2">
                        {todayIncome.map((stream, index) => {
                ...
                <Card className="bg-card/80 backdrop-blur-sm border-primary/20">
                    <CardHeader>
                        <CardTitle className="font-headline text-lg flex items-center gap-2"><TrendingUp className="h-5 w-5"/>Total Income</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-2">
                        {totalIncome.map((stream, index) => {
                            const Icon = stream.icon;
                            return (
                                <div key={index} className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                                    <div className="flex items-center gap-3">
            ...
            <Card className="bg-card/80 backdrop-blur-sm border-primary/20">
                ...
                <CardContent className="grid grid-cols-2 gap-4">
                    {groupWiseTeamDetails.map((detail, index) => {
                        ...
                        return (
                            <div key={index} className="flex flex-col items-center justify-center p-4 bg-muted/50 rounded-lg text-center">
                                <Icon className="h-6 w-6 text-primary mb-2" />
                                <p className="font-medium text-sm text-muted-foreground">{detail.title}</p>
                                <p className="font-bold text-2xl">{detail.count}</p>
                            </div>
                        )
                    })}
                </CardContent>
