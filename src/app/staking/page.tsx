...
export default function StakingPage() {
  return (
    <div className="container mx-auto px-4 py-8 md:px-6 md:py-12">
      ...
      <p className="text-lg text-foreground/80 mb-8">Stake your EGLIFE tokens to earn rewards and support the ecosystem.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">10,530.00 EGLIFE</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">5,000.00 EGLIFE</div>
        ...
        <Tabs defaultValue="stake" className="w-full">
          ...
          <TabsContent value="stake">
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="stake-amount" type="number" placeholder="0.00 EGLIFE" />
              </div>
              <p className="text-sm text-muted-foreground">Enter the amount of EGLIFE you wish to stake. Staked tokens will be locked and start earning rewards immediately.</p>
            </CardContent>
            <CardFooter>
          ...
          <TabsContent value="unstake">
            <CardContent className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">Enter the amount of EGLIFE you wish to unstake. Unstaking may require a cooldown period and will stop reward accrual.</p>
            </CardContent>
            <CardFooter>
